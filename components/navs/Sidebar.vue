<template>
  ...
  >
    ...
    <div class="main-menu-content mt-5 pt-lg-5">
      <ul
        class="navigation navigation-main bg-transparent pt-lg-5"
        id="scroller"
      ...
      >
        ...
        <li class="nav-item has-sub d-none">
          ...
          <ul class="menu-content">
            <template v-for="{ symbol, uniswap_link } in tokens">
              <li @click.stop="" :key="symbol">
        ...
        <li class="nav-item">
          <a href="#" target="_blank">
            <img src="/img/reward.png" height="20" class="mr-2 pr-1" />
        ...
        <li class="nav-item has-sub">
          <a href="#">
            ...
            <span class="ml-2 menu-title">Balancer Pools</span>
          </a>
          <ul class="menu-content">
            <li>
              <nuxt-link to="#!">
